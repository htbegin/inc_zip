...
def create_zip(source_dir: str, files_to_add: List[FileMetadata],
               deleted_paths: List[str], output_path: str, compress: bool = False):
    """
        ...
        with ProcessPoolExecutor() as executor:
            ...
            for meta, content in zip(files_to_add, contents_iterator):
                info = zipfile.ZipInfo(
                    meta.path, date_time=meta.last_modified.timetuple()[:6])
